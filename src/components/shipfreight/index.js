  ...
  return (
    <>
      ...
      <div className=" flex flex-col  lg:pb-2 bg-slate-800">
        ...
        <div className="flex lg:flex-row flex-col lg:pr-16 lg:pt-16 p-8">
          <div className="self-end lg:pl-40 lg:pr-32">
            ...
            <h3 className="font-bold pt-10 2xl:text-3xl text-2xl">
              Ways to Ship
            </h3>
          ...
          <div className="flex-1 h-64 drop-shadow-lg z-10">
            ...
            <p className="text-gray-800 font-normal pt-10 text-xl w-96 pb-8">
        ...
        <h2 className=" self-center font-bold 2xl:pt-10 pt-20 2xl:text-6xl text-4xl ">
      ...
      <div className="lg:ml-40 lg:mr-40 m-0">
        <h3 className="font-bold  text-5xl">Business Solutions</h3>
        <div className="flex flex-row">
        ...
        <div className=" pt-10 pb-10 grid gap-10 lg:grid-cols-2 grid-cols-1">
          <div className="flex flex-col items-start">
            <img src={grid1} className="" width="150px"></img>
